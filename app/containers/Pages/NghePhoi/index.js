...
import { add, getById, getAll, delById, updateById } from '@services/nghephoiService';
...
class NghePhoi extends Component {
  ...
  formatActionCell(value) {
    return <>
      <Link to={URL.NGHE_PHOI_ID.format(value._id)}>
  ...
  render() {
    ...
    return <div>
      ...
      </span>} md="24" bordered extra={<Link to={URL.NGHE_PHOI_ADD}>
...
export default compose(withConnect)(NghePhoi);

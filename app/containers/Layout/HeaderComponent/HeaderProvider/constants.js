export const GET_MY_INFO = 'HeaderComponent/GET_MY_INFO';
export const GET_MY_INFO_SUCCESS = 'HeaderComponent/GET_MY_INFO_SUCCESS';
export const GET_MY_INFO_ERROR = 'HeaderComponent/GET_MY_INFO_ERROR';
